...
export default function Card() {
    ...
    return (
        <div className="flex flex-col bg-[#14253d] p-7 rounded-3xl space-y-4 m-7">

            <div className="relative">
                <a href="#">
                    <img className="w-full rounded-xl hover:opacity-50" src="image-equilibrium.jpg" alt="nft-equilibrium" />
                    <div className="flex absolute items-center justify-center w-full h-full top-0 rounded-xl bg-[#00fff7]/50 opacity-0 sm:hover:opacity-100">
            ...
            <div className="flex flex-col divide-y divide-[#2f415b]">
